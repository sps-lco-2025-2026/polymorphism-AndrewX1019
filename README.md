[![Open in Visual Studio Code](https://classroom.github.com/assets/open-in-vscode-2e0aaae1b6195c2367325f4f02e2d04e9abb55f0b24a779b69b11b9e10269abc.svg)](https://classroom.github.com/online_ide?assignment_repo_id=23675423&assignment_repo_type=AssignmentRepo)
# Polymorphism in OOP
...
The starting code in the solution in this repo is based on the example on the MSDN article "[When to use new and override](https://docs.microsoft.com/en-us/dotnet/csharp/programming-guide/classes-and-structs/knowing-when-to-use-override-and-new-keywords)". 

### References 

The [slides from the lesson](https://docs.google.com/presentation/d/10LflxeVPvTyOB5isuhKWHEhs1ElOUwH0GkR-_SfDCWQ/edit?slide=id.p#slide=id.p), see also Bond 1 pp 148-153. 
